...
<meta name="description" content="早鳥一個幫助你早起的地方"/>
...
<div class="container">
  ...
  <div class="main">
		...
		<div class="header">
			...
			<div class="title">
        <h1><%= link_to "早鳥 Iwakela",{:controller => 'main', :action => 'index'} ,:class => 'ebhead'%></h1>
			</div>
    ...
    <div class="sidenav">
      ...
      <ul>
          <%= link_tab([
                        [ '首頁', 'main', 'index' ],
                        [ '我的早起紀錄', 'member', 'list' ],
                        [ '早鳥嘰嘰喳喳', 'member', 'show_today_results' ],
