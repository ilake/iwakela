...
AppConfig.default_mce_options = {
  ...
  :convert_fonts_to_spans => true,
  :theme_advanced_resize_horizontal => false,
  #:theme_advanced_buttons1 => %w{bold italic underline separator justifyleft justifycenter justifyright indent outdent separator bullist numlist separator link unlink image separator undo redo help code},
  :theme_advanced_buttons1 => %w{bold italic underline separator justifyleft justifycenter justifyright indent outdent separator bullist numlist separator link unlink separator undo redo help code},
  :theme_advanced_buttons2 => [],
  :theme_advanced_buttons3 => [],
  :plugins => %w{media preview curblyadvimage inlinepopups safari},
  :plugin_preview_pageurl => '../../../../../posts/preview',
...
AppConfig.message_mce_options = {
  ...
  :convert_fonts_to_spans => true,
  :theme_advanced_resize_horizontal => false,
  :theme_advanced_buttons1 => %w{bold link unlink undo redo},
  :theme_advanced_buttons2 => [],
  :theme_advanced_buttons3 => [],
  :plugins => %w{inlinepopups safari},
  :editor_selector => "mceMsgEditor"
  }
